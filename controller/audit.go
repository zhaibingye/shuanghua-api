...
var auditContentTemplates = map[string]string{
	...
	"moderation.settings_view":        "Viewed content moderation settings",
	"moderation.conversations_list":   "Listed content moderation conversations",
	"moderation.conversation_view":    "Viewed content moderation conversation ${id}",
	"moderation.violations_list":      "Listed content moderation violations",
	"moderation.users_list":           "Listed content moderation users",
	"moderation.user_view":            "Viewed content moderation user ${id}",
	"moderation.user_update":          "Updated content moderation user ${id}",
	"moderation.user_status":          "Changed content moderation user ${id} status to ${status}",
	"moderation.user_history_delete":  "Deleted content moderation user ${id} history note",
	"moderation.settings_update":      "Updated content moderation settings",
	"moderation.conversation_unblock": "Unblocked content moderation conversation ${id}",
	"moderation.violation_resolve":    "Resolved content moderation violation ${id}",
	"moderation.user_restore":         "Restored user account ${id} after content moderation",
