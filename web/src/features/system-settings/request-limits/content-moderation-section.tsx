...
const contentModerationSchema = z.object({
  ...
  provider: z.enum(["moderations", "responses", "gemini"]),
...
export function ContentModerationSection(props: ContentModerationSectionProps) {
  ...
  const isNativeProvider = selectedProvider === "moderations";
  const providerItems = [
    { value: "moderations", label: t("OpenAI Moderations") },
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent alignItemWithTrigger={false}>
                      <SelectGroup>
                        <SelectItem value="moderations">
                          {t("OpenAI Moderations")}
                        </SelectItem>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder={
                      isNativeProvider || !isGeminiProvider
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  {t("Fail closed is recommended for production enforcement.")}
                </FormDescription>
              </FormItem>
            )}
          />
